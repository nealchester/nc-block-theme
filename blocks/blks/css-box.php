...
function nc_cssbox_block() {
    ...
    acf_register_block_type(array(
        'name'              => 'nc_cssbox',
        'title'             => __('NC Custom CSS', 'nc-block-theme'),
        'description'       => __('A box to write custom CSS for the page', 'nc-block-theme'),
...
function nc_cssbox_block_markup( $block, $content = '', $is_preview = false ) {?>
    ...
    <?php echo get_field('custom_css_box'); ?>
        ...
        .editor-styles-wrapper div.nc-cssbox:before {
            content:"<?php _e('Active Custom CSS Block','nc-block-theme');?>";
        }
    </style>
