...
function nc_singlelink_block() {
        ...
        acf_register_block_type(array(
            'name'              => 'nc_singlelink',
            'title'             => __('NC Single Link', 'nc-block-theme'),
            'description'       => __('A related or important link to showcase', 'nc-block-theme'),
		...
		<a class="ncard_link" href="<?php echo $exlink['url']; ?>"<?php if($exlink['target']) { echo ' target="'.$exlink['target'].'"'; } ?>></a>
			...
			<?php else:?>
				...
				<div class="ncard_text">
					...
					<div class="ncard_title">
						<?php _e('A Sample Link that Goes Nowhere','nc-block-theme');?>
					</div>
