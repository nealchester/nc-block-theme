...
function nc_popup_block() {
        ...
        acf_register_block_type(array(
            'name'              => 'nc_popup',
            'title'             => __('NC PopUp Box', 'nc-block-theme'),
            'description'       => __('Create a popup box that will appear once per session. To see the popup close the page and open it again.', 'nc-block-theme'),
...
/* for frontend */
.wp-site-blocks <?php echo '#'.$id; ?> .ncpopup {
  transition: 0.5s;
...
.wp-site-blocks <?php echo '#'.$id; ?>.ncpopup_overlay {
  position: fixed;
...
.wp-site-blocks <?php echo '#'.$id; ?>.ncpopup_overlay:before {
  content:'';
...
.wp-site-blocks <?php echo '#'.$id; ?>.ncpopup_overlay.open {
  visibility: visible;
  opacity:1;
}

.wp-site-blocks <?php echo '#'.$id; ?>.ncpopup_overlay.open .ncpopup {
  opacity:1;
  top:0;
}
