...
function nc_search_block() {
        ...
        acf_register_block_type(array(
            'name'              => 'nc_search',
            'title'             => __('NC Search Box', 'nc-block-theme'),
            'description'       => __('A search box with additional features.', 'nc-block-theme'),
...
?>
    ...
    <form class="ncsearchform" role="search" method="get" action="<?php echo $address; ?>" id="<?php echo $id; ?>" <?php echo nc_block_attr();?>>
        <div class="ncsearchform_contain">
            <label for="wp-searchbox" class="hidetext"><?php _e('Search','nc-block-theme');?></label>
            <input class="ncsearchform_input" type="search" id="wp-searchbox" name="s" <?php if(is_search()){ echo 'placeholder="'.__('Search again','nc-block-theme').'"'; } else { echo 'placeholder="'.__($placeholder,'nc-block-theme').'"'; } ?>>
