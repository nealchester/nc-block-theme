...
function nc_sliders_block() {
	...
	acf_register_block_type(array(
		'name'              => 'nc_sliders',
		'title'             => __('NC Sliders', 'nc-block-theme'),
		'description'       => __('Slider', 'nc-block-theme'),
...
?>
			...
			<?php else:?>
				...
				<div class="nocontent">
					<p><?php _e('Add some slides to start. Use the sidebar settings to begin.','nc-block-theme');?></p>
				</div>
